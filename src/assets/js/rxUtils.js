...
rxUtils.variable={//此部分区分不同环境的配置，需要在rxUtils-test和rxUtils-prod同时修改，run之前会进行覆盖
  isTest:true,//首页清除缓存按钮
  domainName:'test.taohaifang.com',//微信回调域名
  appid:'wx2bfacb21ef0f3024'//服务号appid
};
rxUtils.cityMap = {
  "Vancouver": "温哥华",
  "North Vancouver": "北温",
...
rxUtils.wxRules='?imageMogr2/auto-orient/thumbnail/100x100>/blur/1x0/quality/75%7Cimageslim';
rxUtils.hostUrl='http://om291r6ss.bkt.clouddn.com/';
//阿里云图片根据设备设置
rxUtils.listImg='http://images.taohaifang.com/';
rxUtils.encImg='http://images.taohaifang.com/';
rxUtils.imgJPG3x = '@' + rxUtils.winW * 3 + rxUtils.imgArgs + '.jpg';
rxUtils.imgPng3x = '@' + rxUtils.winW * 3 + rxUtils.imgArgs + '.png';
rxUtils.hostUrl='http://oetoqzh0i.bkt.clouddn.com/';//host
rxUtils.hostPhoto='http://images.photo.taohaifang.com/',//头像
rxUtils.hostRentHouse='http://images.renthouse.taohaifang.com/',//租房
rxUtils.hostSchool='http://images.school.taohaifang.com/',//学校
rxUtils.hostHouse='http://images.house.taohaifang.com/',//房子
rxUtils.hostAsk='http://images.question.taohaifang.com/',//问答
rxUtils.banner='http://images.taohaifang.com/'//轮播
rxUtils.encImg='http://images.taohaifang.com/';//资讯百科


//千分符
rxUtils.mil = function (str) {
    return str.replace(/\d/g,function(r,i){
        let len = str.indexOf('.')?str.indexOf('.'):str.length;
        let n=(len-1-i);
